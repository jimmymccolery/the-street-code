...
Solo-practitioner application of DBR is a structural extension of the canonical foundation rather than a canonical case in the foundational literature: a single individual occupies both the designer and investigator roles that canonical DBR distributes across collaborators, with the verification function provided by structural means rather than by collaboration. The framework's operator-as-architect-and-practitioner structure operationalizes this configuration. The qualifying claim is design-research-adjacent solo practitioner-research, not canonical multi-stakeholder DBR.

Wang & Hannafin 2005 defined DBR as "a systematic but flexible methodology aimed to improve educational practices through iterative analysis, design, development, and implementation, based on collaboration among researchers and practitioners in real-world settings." The framework fits the systematic-but-flexible criterion and the iterative analysis-design-development-implementation cycle. The collaboration-among-researchers-and-practitioners requirement is where the framework's solo-practitioner application is a structural extension rather than a canonical fit: the framework operates without that collaboration but has structural substitutes (cross-substrate verification chain) for the verification function it normally provides.
