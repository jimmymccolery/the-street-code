...
1. **Rule 20 candidacy Family A — canonization-propagation gap discipline family** — n=20 candidate sub-shapes across framework layers + mechanisms (sub-shape 24 BANKED + sub-shape 25 STRENGTHENED to n=3 within-arc BANK + sub-shape 27 candidate BANKED at scan-architecture-statistics-fabrication layer)
